...
public class ConstraintUtil {
  ...
  private static final Map<String, String> hahes = new HashMap<String, String>(); // "글로벌화해 ", "민족화해" 처럼 화해와 결합이 가능한 명사
  static {
  ...
  private static final Map<String, String> JOSA_TWO = new HashMap<String, String>();
  static {
    JOSA_TWO.put("가", "Y");
    JOSA_TWO.put("는", "Y");
    JOSA_TWO.put("다", "Y");
